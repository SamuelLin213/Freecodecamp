# Word encoding: keeps order of word intact as well as encoding similar words
    # w/ very similar labels attempts to encode not just frequency/order of words,
    # but also the meaning of the word in a sentence
# E.g. Movie review analyzer
